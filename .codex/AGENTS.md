...
1. `.codex/PROJECT_AGENT_GUIDE.md` — objetivo, estado, principios, skills y definicion de terminado.
2. `.codex/PRODUCT_COMPLETION_PLAN.md` — plan de finalizacion por fases (1-6).
3. `.codex/TECHNICAL_REFERENCES.md` — mapa de archivos y flujos criticos.
4. `.codex/NEXT_ITERATION_CHECKLIST.md` — checklist de pendientes.
